...
// Can be set by by EnvWindowsTestHelper::SetReadOnlyMMapLimit().
        ...
        public:
            ...
            ScopedHandle(ScopedHandle &&other) noexcept : handle_(
                    other.Release()) {}
...
// to determine cause of failure
        ...
        public:
            ...
            Status NewSequentialFile(const std::string &filename,
                ...
                *result = new WindowsSequentialFile(filename,
                                                    std::move(handle));
                return Status::OK();
            }
            ...
            Status NewRandomAccessFile(const std::string &filename,
                ...
                *result = nullptr;
                ...
                DWORD share_mode = FILE_SHARE_READ;
                ScopedHandle handle =
                        ::CreateFileA(filename.c_str(), desired_access,
                                      share_mode,
                                /*lpSecurityAttributes=*/nullptr, OPEN_EXISTING,
                ...
                if (!mmap_limiter_.Acquire()) {
                    *result = new WindowsRandomAccessFile(filename,
                                                          std::move(handle));
                    return Status::OK();
                }
                ...
                ScopedHandle mapping =
                        ::CreateFileMappingA(handle.get(),
                                ...
                                /*lpName=*/nullptr);
                if (mapping.is_valid()) {
                    void *mmap_base = ::MapViewOfFile(mapping.get(),
                                                      FILE_MAP_READ,
                            /*dwFileOffsetHigh=*/0,
                            /*dwFileOffsetLow=*/0,
            ...
            bool FileExists(const std::string &filename) override {
                return GetFileAttributesA(filename.c_str()) !=
            ...
            Status GetChildren(const std::string &directory_path,
                ...
                HANDLE dir_handle = ::FindFirstFileA(find_pattern.c_str(),
                                                     &find_data);
                ...
                do {
                    ...
                    if (!_splitpath_s(find_data.cFileName, nullptr, 0, nullptr,
                                      0, base_name,
                                      ARRAYSIZE(base_name), ext,
                                      ARRAYSIZE(ext))) {
            ...
            Status RenameFile(const std::string &from,
                ...
                if (::ReplaceFileA(to.c_str(),
                                   from.c_str(), /*lpBackupFileName=*/nullptr,
                                   REPLACEFILE_IGNORE_MERGE_ERRORS,
            ...
            Status UnlockFile(FileLock *lock) override {
                ...
                if (!LockOrUnlock(windows_file_lock->handle().get(), false)) {
                    return WindowsError(
                            "unlock " + windows_file_lock->filename(),
                            ::GetLastError());
                }
        ...
        void WindowsEnv::Schedule(
            ...
            if (!started_background_thread_) {
                ...
                std::thread background_thread(
                        WindowsEnv::BackgroundThreadEntryPoint, this);
