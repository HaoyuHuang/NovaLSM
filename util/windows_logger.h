        ...
        void Logv(const char *format, va_list arguments) override {
            ...
            for (int iteration = 0; iteration < 2; ++iteration) {
                const int buffer_size =
                        (iteration == 0) ? kStackBufferSize
                                         : dynamic_buffer_size;
                char *const buffer =
                        (iteration == 0) ? stack_buffer
                                         : new char[dynamic_buffer_size];
                ...
                int buffer_offset = snprintf(
                        ...
                        now_components.wDay,
                        now_components.wHour, now_components.wMinute,
                ...
                buffer_offset +=
                        std::vsnprintf(buffer + buffer_offset,
