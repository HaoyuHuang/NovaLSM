...
// A basic file truncation function suitable for this test.
        ...
        struct FileState {
            ...
            FileState() : pos_(-1), pos_at_last_sync_(-1),
                          pos_at_last_flush_(-1) {}
...
// is written to or sync'ed.
    ...
    private:
        ...
        bool filesystem_active_ GUARDED_BY(
                mutex_);  // Record flushes, syncs, writes
    };

    TestWritableFile::TestWritableFile(const FileState &state, WritableFile *f,
                                       FaultInjectionTestEnv *env)
            : state_(state), target_(f), writable_file_opened_(true),
              env_(env) {
        assert(f != nullptr);
    }
    ...
    public:
        ...
        void PartialCompactTestReopenWithFault(ResetMethod reset_method,
            ...
            ASSERT_OK(Verify(0, num_pre_sync,
                             FaultInjectionTest::VAL_EXPECT_NO_ERROR));
