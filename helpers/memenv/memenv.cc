...
namespace leveldb {
    ...
    namespace {
        ...
        public:
            explicit RandomAccessFileImpl(FileState *file) : file_(
                    file) { file_->Ref(); }
        ...
        public:
            ...
            Status CreateDir(
                    const std::string &dirname) override { return Status::OK(); }
            ...
            Status
            LockFile(const std::string &fname, FileLock **lock) override {
                *lock = new FileLock;
                return Status::OK();
            }
            ...
            Status
            NewLogger(const std::string &fname, Logger **result) override {
