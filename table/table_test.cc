...
// BlockBuilder/TableBuilder and Block/Table.
    ...
    public:
        ...
        virtual Status
        FinishImpl(const Options &options, const KVMap &data) = 0;
    ...
    public:
        ...
        Iterator *NewIterator() const override {
            return table_->NewIterator(AccessCaller::kUncategorized,
                                       ReadOptions());
        }
...
// A helper class that converts internal format keys into user keys
    ...
    public:
        ...
        operator=(const KeyConvertingIterator &) = delete;
    ...
    public:
        explicit MemTableConstructor(const Comparator *cmp)
            ...
            memtable_ = new MemTable(internal_comparator_, nullptr);
            memtable_->Ref();
        }
        ...
        Iterator *NewIterator() const override {
            return new KeyConvertingIterator(
                    memtable_->NewIterator(TraceType::MEMTABLE,
    ...
    public:
        ...
        std::string
        ToString(const KVMap &data, const KVMap::const_iterator &it) {
            if (it == data.end()) {
                return "END";
            } else {
...
// Test the empty key
    ...
    TEST(MemTableTest, Simple) {
        ...
        MemTable *memtable = new MemTable(cmp, nullptr);
        memtable->Ref();
        WriteBatch batch;
        ...
        Iterator *iter = memtable->NewIterator(TraceType::MEMTABLE,
                                               AccessCaller::kUncategorized);
        iter->SeekToFirst();
        while (iter->Valid()) {
    ...
    TEST(TableTest, ApproximateOffsetOfCompressed) {
        ...
        ASSERT_TRUE(
                Between(c.ApproximateOffsetOf("xyz"), 2 * min_z, 2 * max_z));
    }
