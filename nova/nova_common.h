...
#define HASHPOWER_DEFAULT 16
    ...
    struct GlobalSSTableHandle {
        ...
        bool operator<(const GlobalSSTableHandle &h2) const {
            return true;
//            return std::tie(configuration_id, partition_id, cc_id, table_id) <
//                   std::tie(xyz.configuration_id, xyz.partition_id, xyz.cc_id,
//                            xyz.table_id);
        }
    };
    ...
    struct GlobalBlockHandle {
        ...
        bool operator<(const GlobalBlockHandle &h2) const {
            return true;
//            return std::tie(table_handle, block_handle) <
//                   std::tie(xyz.table_handle, xyz.block_handle);
        }
    };
    ...
    struct GlobalLogFileHandle {
        ...
        bool operator<(const GlobalLogFileHandle &h2) const {
            return true;
//            return std::tie(configuration_id, mc_id, log_id) <
//                   std::tie(xyz.configuration_id, xyz.mc_id, xyz.log_id);
        }
    };
